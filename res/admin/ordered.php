...
if(isset($_SESSION['update']))
     ...
     <a href="<?php echo SITEURL; ?>admin/printnew.php" class="btn-primary">Print</a>
...
<table class="tblf" >
   ...
   $sql="SELECT * FROM ordertbl WHERE status='ordered'";//display latest order first
   ...
   if($count>0)
   {
      while ($row=mysqli_fetch_assoc($result)) {
          ...
          <td>
          <a href="<?php echo SITEURL; ?>admin/update-order.php?id=<?php echo $id ?>" class="btn-secondary">Ordered</a> 
