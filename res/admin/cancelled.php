...
if(isset($_SESSION['update']))
     ...
     <a href="<?php echo SITEURL; ?>admin/printcanc.php" class="btn-primary">Print</a>
...
<table class="tblf" >
   ...
   $sql="SELECT * FROM ordertbl WHERE status='cancelled'";//display latest order first
   ...
   if($count>0)
   {
      while ($row=mysqli_fetch_assoc($result)) {
          ...
          <td>
          <a href="<?php echo SITEURL; ?>admin/update-order.php?id=<?php echo $id ?>" class="btn-secondary">Cancelled</a> 
   ...
   {
    //order not avail
     echo "<tr><td colspan='12' class='error'>No Order  cancelled</td></tr>";
   }
   ?>
