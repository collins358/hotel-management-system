...
<script type="text/javascript">     
    function PrintDiv() {    
       ...
       var popupWin = window.open('', '_blank', 'width=6000,height=6000');
...
<img src="<?php echo SITEURL; ?>images/logo.png" width="100px" height="50PX" style="left: 100%;">
<h1>All Orders</h1>
<br><br>
...
<div>
  <input type="button" class="btn-primary" value="print" onclick="PrintDiv();" />
</div><br><br>
